...
def mod_optimized_generation(**kwargs):
    ...
    diff_text_states = optimized_states.detach()-ori_text_states
    diff_img_states = optimized_states_img.detach()-ori_img_states
    
    return new_img, reward_history, ori_total_length, generated_seq, updated_length, diff_text_states, diff_img_states, update_length, img_update_length